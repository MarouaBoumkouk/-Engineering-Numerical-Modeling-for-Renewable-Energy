...
class SouthForkWindVisualizer:
    def __init__(self, boundary_file="SouthForkpolygon.geojson", turbines_file="SouthForkpoint.geojson"):
    ...
    def _load_boundary(self):
        ...
        for feature in geojson["features"]:
            if feature["geometry"]["type"] == "Polygon":
                ...
                # Handle nested vs flat Polygon formats
    ...
    def plot_layout_with_aep(self, aep_value):
        ...
        plt.scatter(self.turbines_array[:, 0], self.turbines_array[:, 1], color='purple', label='Turbines', zorder=5)
...
if __name__ == "__main__":
    visualizer = SouthForkWindVisualizer()
